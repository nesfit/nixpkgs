...
, nugetDeps ? null
  # NuGet config used for authentication
, nugetConfig ? ""
  ...
  passthru = {
    ...
    fetch-deps =
      ...
      writeShellScript "fetch-${pname}-deps" ''
        ...
        export PATH="${lib.makeBinPath [ coreutils runtimeShellPackage dotnet-sdk (nuget-to-nix.override { inherit dotnet-sdk nugetConfig; }) ]}"
